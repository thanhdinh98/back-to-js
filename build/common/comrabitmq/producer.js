...
var Producer = (function () {
    function Producer(rabbitMqProducer) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = Producer.bind;
                    return [4, (0, rabbitmq_1.NewRabbitMqProducer)(queue)];
                case 1:
                    producer = new (_a.apply(Producer, [void 0, _b.sent()]))();
                    return [2, producer];
            }
        });
    });
